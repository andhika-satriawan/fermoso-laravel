...
{
    private $view_path = 'pages.admin.faq.category.';
    private $route_path = 'admin.faq.category.';
    private $page_info = [];

    public function __construct()
    {
        $this->page_info['title'] = 'FAQ Category';
    }
    ...
    {
        $categories = MasterFaqCategory::orderBy('id')->get();
    ...
    {
        $item = MasterFaqCategory::findOrFail($id);
