                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <div class="addresses-content">
                            ...
                            <form action="{{ route('my_account.address.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group @error('address_detail') has-error @enderror">
                                            ...
                                            <textarea class="input form-control" name="address_detail" id="address_detail" cols="30" rows="5" placeholder="Jalan Raya Setiabudi"></textarea>
                                ...
                                <button class="button pull-right" type="submit">Simpan Alamat</button>
