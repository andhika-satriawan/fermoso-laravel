...
@push('addon-style-2b01b')
    <link rel="stylesheet" href="{{ asset('css/2b01b.css') }}" />
@endpush
@push('addon-style-dcbdf')
    <link rel="stylesheet" href="{{ asset('css/dcbdf.css') }}" />
@endpush
@push('addon-style-22b88')
    <link rel="stylesheet" href="{{ asset('css/22b88.css') }}" />
@endpush
