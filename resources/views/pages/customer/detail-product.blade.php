...
<head>
    ...
    <link rel=alternate type=application/rss+xml title="KuteShop &raquo; Ring Platinum Plated Comments Feed"
        href=https://kuteshop.kutethemes.net/product/ring-platinum-plated/feed/>
...
<body data-rsssl=1
    ...
    <div id=page class=site>
        ...
        <div id="content" class="container site-content sidebar-full product-page product-page-standard">
            <nav class="woocommerce-breadcrumb">
                ...
                <a href="{{ 'category/' . $product->product_subcategory->slug }}">{{ $product->product_subcategory->name }}</a><span class="delimiter"></span>
                {{ $product->name }}
            </nav>
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    ...
                    <div id="product-2325"
                        class="product type-product post-2325 status-publish first instock product_cat-earring product_cat-wedding-rings has-post-thumbnail shipping-taxable purchasable product-type-simple">
                        <div class="single-product-wrapper has-gallery"
                            ...
                            <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images"
                                ...
                                <div class="woocommerce-product-gallery__wrapper">
                                    ...
                                    <div data-thumb="{{ Storage::url($product_detail->image) }}" data-thumb-alt class="woocommerce-product-gallery__image">
                                        <a href="{{ Storage::url($product_detail->image) }}">
                                            <img width="800" height="961"
                                                src="{{ Storage::url($product_detail->image) }}"
                                                class="wp-post-image" alt title="jewel-h1-08" data-caption
                                                data-src="{{ Storage::url($product_detail->image) }}"
                                                data-large_image="{{ Storage::url($product_detail->image) }}"
                                                data-large_image_width="850" data-large_image_height="1021" decoding="async"
                                                fetchpriority="high"
                                                srcset="{{ Storage::url($product_detail->image) }} 800w, {{ Storage::url($product_detail->image) }} 250w, {{ Storage::url($product_detail->image) }} 768w, {{ Storage::url($product_detail->image) }} 128w, {{ Storage::url($product_detail->image) }} 86w, {{ Storage::url($product_detail->image) }} 64w, {{ Storage::url($product_detail->image) }} 268w, {{ Storage::url($product_detail->image) }} 84w, {{ Storage::url($product_detail->image) }} 233w, {{ Storage::url($product_detail->image) }} 193w, {{ Storage::url($product_detail->image) }} 224w, {{ Storage::url($product_detail->image) }} 850w"
                            ...
                            <div class="summary entry-summary">
                                <h1 class="product_title entry-title">{{ $product_detail->name }}</h1>
                                ...
                                <div class="woocommerce-product-details__short-description">
                                    <ul>
                                        <li>Platinum with round brilliant diamonds</li>
                                        <li>1.8 mm wide</li>
                                        <li>Carat total weight .23</li>
                                        <li>Product number:60004581</li>
                                    </ul>
                                </div>
                                ...
                                <form class="cart" action="" method="post" enctype="multipart/form-data">
                                    <div class=quantity>
                                        <a href="#" class="arrow minus quantity-minus"></a> <label
                                            class="screen-reader-text" for="quantity_6580c1cd93437">Ring Platinum Plated quantity</label>
                                        <input type=number id=quantity_6580c1cd93437 class="input-text qty text"
                                            name=quantity value=1 aria-label="Product quantity" size=4 min=1 max step=1
                                            placeholder inputmode=numeric autocomplete=off>
                                        <a href=# class="arrow plus quantity-plus"></a>
                                    </div><button type=submit name=add-to-cart value=2325
                                    ...
                                    <div class="yith-wcwl-add-to-wishlist add-to-wishlist-2325  wishlist-fragment on-first-load"
                                        ...
                                        data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:true,&quot;show_exists&quot;:false,&quot;product_id&quot;:2325,&quot;parent_product_id&quot;:2325,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:true,&quot;browse_wishlist_text&quot;:&quot;Browse&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;main-icon-heart1 ovic-wl-icon&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}">
                                        <div class=yith-wcwl-add-button>
                                            <a href="?add_to_wishlist=2325&#038;_wpnonce=4dec6caba3"
                                                class="add_to_wishlist single_add_to_wishlist" data-product-id=2325
                                                data-product-type=simple data-original-product-id=2325
                                    ...
                                    <a href="https://kuteshop.kutethemes.net?action=yith-woocompare-add-product&id=2325"
                                        class="compare button" data-product_id=2325 rel=nofollow>Compare</a>
                                </form>
                                <div class=product_meta>
                                    <span class=sku_wrapper>
                                        <span class=title>SKU:</span> 
                                        <span class=sku>{{ $product->details->first()->sku }}</span>
                                    </span>
                                    <span class=posted_in>
                                        <span class=title>Categories:</span>
                                        <a href="{{ 'category/' . $product->product_subcategory->slug }}">{{ $product->product_subcategory->name }}</a>
                                        </span>
                                </div>
                                <div class=delivery-info>
                                    <div class=item>
                                        <span class="icon main-icon-truck"></span>
                                        <span class=text>Estimate delivery times: <b>3-4 days</b>
                                            (International).</span>
                                    </div>
                                    <div class=item>
                                ...
                                <div class="payment-info">
                                    <div class="item">
                                        ...
                                        <span class="image">
                                            <img src="https://kuteshop.b-cdn.net/wp-content/uploads/2023/02/product-payment.svg"
                        ...
                        <section class="related products ovic-products style-01  border-full">
                            ...
                            <div class="owl-slick products product-list-owl rows-space-0 equal-container better-height"
                                ...
                                <div class="product-item style-01 product type-product post-{{ $related_product->id }} status-publish instock product_cat-wedding-rings product_cat-earring product_cat-necklaces product_tag-market has-post-thumbnail sale shipping-taxable purchasable product-type-simple">
                                    <div class="product-inner product-01 add-cart-01">
                                        <div class="product-thumb tooltip-wrap tooltip-start">
                                            ...
                                            <div class="group-button style-01 popup">
                                                <div class="yith-wcwl-add-to-wishlist add-to-wishlist-2662  wishlist-fragment on-first-load"
                                                    ...
                                                    <div class=yith-wcwl-add-button>
                                                        <a href="?add_to_wishlist=2662&#038;_wpnonce=4dec6caba3"
                                                            class="add_to_wishlist single_add_to_wishlist"
                                                            data-product-id=2662 data-product-type=simple
                                                            data-original-product-id=2662 data-title=Wishlist
                                                            rel=nofollow>
                                                            <i
                                                ...
                                                <div class="woocommerce product compare-button"><a
                                                        href="https://kuteshop.kutethemes.net?action=yith-woocompare-add-product&id=2662"
                                                        class="compare button" data-product_id=2662
                                                        rel=nofollow>Compare</a></div><a href=#
                                                    class="button yith-wcqv-button" data-product_id=2662>Quick View</a>
                                            </div>
                                            <span class=add-to-cart data-title="Add to cart"><a
                                                    href="https://kuteshop.kutethemes.net/product/ring-platinum-plated/?add-to-cart=2662"
                                                    data-quantity=1
                                                    class="button product_type_simple add_to_cart_button ajax_add_to_cart"
                                                    data-product_id=2662 data-product_sku=MK-J-008
                                                    aria-label="Add &ldquo;{{ $related_product->name }}&rdquo; to your cart"
                                                    aria-describedby rel=nofollow>Add to cart</a></span>
                                        </div>
                                        <div class="product-info equal-elem">
                                            <h2 class="product-title">
                                                <a href="{{ url('product/' . $related_product->slug) }}">{{ $related_product->name }}</a>
                                            </h2>
                                            <div class=star-rating-wrap>
                                                <div class=star-rating role=img aria-label="Rated 4.25 out of 5"><span
                                                        ...
                                                        5</span></div><strong class=rating-count>04</strong><a
                                                    href=#reviews class=woocommerce-review-link rel=nofollow>Add your
                                                    review</a>
                                            </div>
                                            <span class=price>
                                                <ins>
                                                                    ...
                                                                    <div class=content>
                                                                        ...
                                                                        <form id=mc4wp-form-1
                                                                            ...
                                                                            <div class=mc4wp-form-fields> <label
                                                                                ...
                                                                                value=1702937037><input type=hidden
    ...
    <a href="/product/ring-platinum-plated/?demo=21&d=rtl" class="ovic-rtl-button" style="display: none">Change to <span>RTL</span></a>
    <div id="ovic-menu-mobile-1" class="ovic-menu-clone-wrap mobile-main-menu loaded"
        ...
        <div class=ovic-menu-panels>
            <div id=ovic-menu-panel-main-6580c1cdd5765 class='ovic-menu-panel ovic-menu-panel-main'>
                <ul class=depth-0>
                    <li
                    ...
                    <li
                        ...
                        <a class=ovic-menu-next-panel href=#ovic-menu-panel-437></a><a class=menu-link
                            ...
                            Plus</a></li>
                    <li
                        class='menu-item menu-item-type-taxonomy menu-item-object-product_cat current-product-ancestor menu-item menu-item-444 menu-item-icon-image'>
                        <a class=menu-link
    ...
    <script type=application/ld+json>
        {
            ...
            "@graph": [{
                ...
                "itemListElement": [{
                    ...
                    "item": {
                        "name": "Jewelry",
                        "@id": "https:\/\/kuteshop.kutethemes.net\/product-category\/market\/jewelry\/?demo=21"
                    }
                }, {
                    "@type": "ListItem",
                    "position": 4,
                    "item": {
                        "name": "Wedding Rings",
                        "@id": "https:\/\/kuteshop.kutethemes.net\/product-category\/market\/jewelry\/wedding-rings\/?demo=21"
                    }
                }, {
                    "@type": "ListItem",
                    "position": 5,
                    "item": {
                        "name": "Ring Platinum Plated",
                        "@id": "https:\/\/kuteshop.kutethemes.net\/product\/ring-platinum-plated\/"
                    }
                }]
            }, {
                "@context": "https:\/\/schema.org\/",
                "@type": "Product",
                "@id": "https:\/\/kuteshop.kutethemes.net\/product\/ring-platinum-plated\/#product",
                "name": "Ring Platinum Plated",
                "url": "https:\/\/kuteshop.kutethemes.net\/product\/ring-platinum-plated\/",
                "description": "Platinum with round brilliant diamonds\r\n \t1.8 mm wide\r\n \tCarat total weight .23\r\n \tProduct number:60004581",
                ...
                "offers": [{
                    ...
                    "seller": {
                        "@type": "Organization",
                        "name": "KuteShop",
                        "url": "https:\/\/kuteshop.kutethemes.net"
                    }
                }],
                "aggregateRating": {
                ...
                "review": [{
                    ...
                    "reviewBody": "It is beautiful and hight quality. I will continue to buy to give to friends and relatives",
                    "datePublished": "2021-08-29T08:41:57+00:00"
                }],
                "mpn": "MK-J-002",
                "brand": "Lack"
            }]
    ...
    <script id="jquery-yith-wcwl-js-extra">
        var yith_wcwl_l10n = {
            ...
            "nonce": {
                "add_to_wishlist_nonce": "4dec6caba3",
                "remove_from_wishlist_nonce": "dd03b12275",
                "reload_wishlist_and_adding_elem_nonce": "a5e41873f7",
                "load_mobile_nonce": "d9e6affc97",
                "delete_item_nonce": "c946f98ba8",
                "save_title_nonce": "f4c6e55cd8",
                "save_privacy_nonce": "d7c4b6d23c",
                "load_fragments_nonce": "4394d0ec39"
            },
    ...
    <script defer src=https://kuteshop.b-cdn.net/wp-content/cache/minify/1/09437.js></script>
    ...
    <script id=elementor-frontend-js-before>
        var elementorFrontendConfig = {
            ...
            "post": {
                "id": 2325,
                "title": "Ring%20Platinum%20Plated%20%E2%80%93%20KuteShop",
                "excerpt": "<ul>\r\n \t<li>Platinum with round brilliant diamonds<\/li>\r\n \t<li>1.8 mm wide<\/li>\r\n \t<li>Carat total weight .23<\/li>\r\n \t<li>Product number:60004581<\/li>\r\n<\/ul>",
                "featuredImage": "https:\/\/kuteshop.kutethemes.net\/wp-content\/uploads\/2021\/08\/jewel-h1-08.jpg"
            }
        };
    </script>
