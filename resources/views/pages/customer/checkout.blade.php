    ...
    <div class="columns-container">
        <div class="container" id="columns">
            ...
            <div class="page-content checkout-page">
                ...
                <form action="{{ route('transaction.store') }}" id="formSubmission" method="post" id=""
                                ...
                                @foreach ($addresses as $address)
                                    <li>
                                        <div class="address-item">
                                            <input type="radio" id="{{ $address->id }}-1" name="address_id"
                                                value="{{ $address->id }}">
                    ...
                    <div class="box-border">
                        <ul class="shipping_method">
                            <li>
                                <label for="jne"><input type="radio" name="courier" id="jne"
                                        value="jne">JNE</label>
                            </li>
                            {{-- <li>
                            ...
                            <li>
                                <label for="jnt"><input type="radio" name="courier" id="jnt"
                                        value="jnt">JNT</label>
                            </li>
                        </ul>
                        <br />
...
@push('addon-script')
    <script>
                            ...
                            const selectList = responseData.map((e) => {
                                ...
                                <li>
                                    <label for="shipping_option-${e.service}">
                                        ...
                                        >
                                            ${e.service} - Rp ${e.cost[0].value.toLocaleString().replace(/,/g, '.')} (${e.cost[0].etd} hari)
                                    </label>
                                </li>
                            `;
                            });
        ...
        $(document).on('change', 'input[type=radio][name="shipping_option"]', function() {
            ...
            $('#shippingCost').text(`Rp ${parseInt(shipping_cost).toLocaleString().replace(/,/g, '.')}`);
            $('#totalCost').text(
                `Rp ${(parseInt(total_carts)+parseInt(shipping_cost)).toLocaleString().replace(/,/g, '.')}`);
        });
    </script>
@endpush
