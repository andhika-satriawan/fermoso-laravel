    ...
    <div class="columns-container">
        <div class="container" id="columns">
            ...
            <div class="breadcrumb clearfix">
                ...
                <span class="navigation_page">{{ $current_subcategory->name }}</span>
            </div>
            <!-- ./breadcrumb -->
            <!-- row -->
            <div class="row">
                ...
                <div class="column col-xs-12 col-sm-3" id="left_column">
                                ...
                                <div class="layered-content">
                                    <ul class="tree-menu">
                                        @foreach ($product_subcategories as $product_subcategory)
                                            <li
                                                class="{{ $product_subcategory->name === $current_subcategory->name ? 'active' : '' }}">
                                                <span></span>
                    ...
                    <div class="col-left-slide left-module">
                        <ul class="owl-carousel owl-style2" data-loop="true" data-nav = "false" data-margin = "30"
                            ...
                            data-autoplay="true">
                            <li><a href="#"><img src="{{ asset('customer/assets/data/slide-left.jpg') }}"
                                        alt="slide-left"></a>
                            </li>
                            <li><a href="#"><img src="{{ asset('customer/assets/data/slide-left2.jpg') }}"
                                        alt="slide-left"></a>
                            </li>
                            <li><a href="#"><img src="{{ asset('customer/assets/data/slide-left3.png') }}"
                                        alt="slide-left"></a>
                            </li>
                        </ul>
                            ...
                            <ul class="products-block">
                                <li>
                                    <div class="products-block-left">
                                        <a href="#">
                                            <img src="{{ asset('customer/assets/data/product-100x122.jpg') }}"
                ...
                <div class="center_column col-xs-12 col-sm-9" id="center_column">
                    ...
                    <div id="view-product-list" class="view-product-list">
                        <h2 class="page-heading">
                            <span class="page-heading-title">{{ $current_subcategory->name }}</span>
                        </h2>
