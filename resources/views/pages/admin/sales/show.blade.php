                            ...
                            <td colspan="6" style="padding: 5px; vertical-align: top">
                                <table style="width: 100%;line-height: inherit;text-align: left;">
                                    <tbody>
                                        <tr>
                                            <td
                                                style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px;width:70%;">
                                                ...
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        ...
                                                        {{ $item->recipient_name }} </font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                        {{ $item->customer->email }} </font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                ...
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                        {{ $item->shipping_address }} </font>
                                                </font><br>
                                            </td>
                                            <td
                                                style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px;width:15%;">
                                                <font style="vertical-align: inherit;margin-bottom:25px;">
                                                    <font
                                                        style="vertical-align: inherit;font-size:14px;color:#7367F0;font-weight:600;line-height: 35px; ">
                                                        Invoice Info</font>
                                                ...
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                        Shipping Status ({{ strtoupper($item->courier) }} -
                                                        {{ $item->service }})</font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    <font
                                            ...
                                            <td
                                                style="padding:5px;vertical-align:top;text-align:right;padding-bottom:20px;width:15%;">
                                                <font style="vertical-align: inherit;margin-bottom:25px;">
                                                    <font
                                                        style="vertical-align: inherit;font-size:14px;color:#7367F0;font-weight:600;line-height: 35px; ">
                                                        &nbsp;</font>
                                                ...
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        ...
                                                        {{ $item->shipping_status }}</font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    @if ($item->transaction_status == 'PENDING')
                                                        <font
                                                            style="vertical-align: inherit;font-size: 14px;color: #ea5455;font-weight: 400;">
                                                            {{ $item->transaction_status }} </font>
                                                    @elseif ($item->transaction_status == 'DIKEMAS')
                                                        <font
                                                            style="vertical-align: inherit;font-size: 14px;color: #f90;font-weight: 400;">
                                                            {{ $item->transaction_status }} </font>
                                                    ...
                                                    @elseif ($item->transaction_status == 'SELESAI')
                                                        <font
                                                            style="vertical-align: inherit;font-size: 14px;color: #28c76f;font-weight: 400;">
                                                            {{ $item->transaction_status }} </font>
                                                    @elseif ($item->transaction_status == 'CANCELLED')
                                                        <font
                                                            style="vertical-align: inherit;font-size: 14px;color: #637381;font-weight: 400;">
                                                            {{ $item->transaction_status }} </font>
                                                    @else
                                                        Undefined
                                                    @endif
                        ...
                        @foreach ($item->transaction_details as $detail)
                            <tr class="details" style="border-bottom: 1px solid #e9ecef">
                                <td style="padding: 10px;vertical-align: top;display: flex;align-items: center;">
                                    <img src="{{ Storage::url($detail->product->photo) }}" alt="img" class="me-2"
                                ...
                                <td style="padding: 10px; vertical-align: top">
                                    ...
                                    @if ($detail->original_price > $detail->price)
                                        <s class="text-danger">Rp
                                            {{ number_format($detail->original_price, 0, ',', '.') }}</s>
                                ...
                                <td style="padding: 10px; vertical-align: top">
                                    {{ number_format($detail->original_price - $detail->price, 0, ',', '.') }}
                                </td>
                    ...
                    <div class="total-order w-100 max-widthauto m-auto mb-4">
                        <ul>
                            ...
                            <li>
                                ...
                                <h5>Rp {{ number_format($item->shipping_price, 0, ',', '.') }}</h5>
                            </li>
                            <li class="total">
                                <h4>Grand Total</h4>
                    ...
                    <form action="{{ route('admin.sales.update_status', $item->id) }}" id="formSubmission" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <select class="select @error('status') is-invalid @enderror" name="status" required>
                                ...
                                <option value="DIKEMAS" @if ($item->transaction_status == 'DIKEMAS') selected @endif>Dikemas</option>
                                <option value="DALAM PENGIRIMAN" @if ($item->transaction_status == 'DALAM PENGIRIMAN') selected @endif>Dalam
                                    Pengiriman</option>
                                <option value="SELESAI" @if ($item->transaction_status == 'SELESAI') selected @endif>Selesai</option>
                                <option value="CANCELLED" @if ($item->transaction_status == 'CANCELLED') selected @endif>Cancelled
                                </option>
                            </select>
                            @error('status')
                    ...
                    <form action="{{ route('admin.sales.update_resi', $item->id) }}" id="formSubmission" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('resi') is-invalid @enderror" id="resi"
                                placeholder="No. Resi" name="resi" value="{{ $item->resi }}" autocomplete="off"
                                required>
                            @error('resi')
                                <div class="invalid-feedback">
                                    {{ $message }}
