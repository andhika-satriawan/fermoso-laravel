...
<div class="page-header">
    ...
    <div class="page-btn">
      <a href="{{ route('admin.product.category.create') }}" class="btn btn-added">
        <img
            ...
            <table class="table datanew">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="me-3" href="{{ route('admin.product.category.edit', $category->id)}}">
    ...
    const deleteConfirmation = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '{{ route("admin.product.category.index") }}/' + id,
                    data: {
