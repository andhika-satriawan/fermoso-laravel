...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.product.subcategory.store') }}" id="formSubmission" method="post" id="" enctype="multipart/form-data">
        @csrf
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('subcategory_name') is-invalid @enderror" id="subcategory_name" placeholder="Sub Category Name" name="subcategory_name" value="{{ old('subcategory_name') }}" autocomplete="off" required>
