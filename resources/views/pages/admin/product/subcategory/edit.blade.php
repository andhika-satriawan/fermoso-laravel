...
@section('content')
    ...
    <form action="{{ route('admin.product.subcategory.update', $item->id) }}" id="formSubmission" method="post"
                ...
                <div class="card image-uploader">
                    <div class="card-body">
                        ...
                        <img class="card-img-top image-uploader-preview" 
                            src="{{ isset($item->icon) ? Storage::url($item->icon) : asset('admin/img/product/upload.png') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 upload-product">
                <div class="card image-uploader">
                    <div class="card-body">
                        ...
                        @enderror
                        <img class="card-img-top image-uploader-preview" 
                            src="{{ isset($item->image) ? Storage::url($item->image) : asset('admin/img/product/upload.png') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 upload-product">
                <div class="card image-uploader">
                    <div class="card-body">
                        ...
                        @enderror
                        <img class="card-img-top image-uploader-preview" 
                            src="{{ isset($item->featured_image) ? Storage::url($item->featured_image) : asset('admin/img/product/upload.png') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 upload-product">
                <div class="card image-uploader">
                    <div class="card-body">
                        ...
                        @enderror
                        <img class="card-img-top image-uploader-preview" 
                            src="{{ isset($item->banner_top) ? Storage::url($item->banner_top) : asset('admin/img/product/upload.png') }}">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 upload-product">
                <div class="card image-uploader">
                    <div class="card-body">
                        ...
                        @enderror
                        <img class="card-img-top image-uploader-preview" 
                            src="{{ isset($item->banner_left) ? Storage::url($item->banner_left) : asset('admin/img/product/upload.png') }}">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 upload-product">
                <div class="card image-uploader">
                    <div class="card-body">
                        ...
                        @enderror
                        <img class="card-img-top image-uploader-preview" 
                            src="{{ isset($item->banner_right) ? Storage::url($item->banner_right) : asset('admin/img/product/upload.png') }}">
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="product_category_id" class="form-label">Sub Category Name <span
                                    ...
                                    <select class="select @error('product_category_id') is-invalid @enderror"
                                        ...
                                        @foreach ($categories as $category)
                                            <option @if ($item->product_category_id == $category->id) selected @endif value="{{ $category->id }}">
