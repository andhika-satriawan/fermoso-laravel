...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('admin.product.list.store') }}" id="formSubmission" method="post" id="" enctype="multipart/form-data">
        @csrf
            <div class="row upload-product">
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="card image-uploader">
                        <div class="card-body">
                            ...
                            <input 
                                class="form-control file-uploader @error('photo') is-invalid @enderror" 
                                type="file" 
                                accept="image/*" 
                                name="photo"
                                value="{{ old('photo') }}"
                ...
                @foreach (array(2,3,4) as $image_no)
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card image-uploader">
                            <div class="card-body">
                            ...
                            <img class="card-img-top image-uploader-preview" src="{{ old('productImages[' . $loop->index . '][photo]') != '' ? old('productImages[' . $loop->index . '][photo]') : asset('admin/img/product/upload.png') }}">
                        </div>
                    </div>
                @endforeach
            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input 
                                                ...
                                                placeholder="Width"
                                                aria-label="Width" aria-describedby="width" 
                                                name="width"
                                                value="{{ old('width') }}"
                                            >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input 
                                                ...
                                                placeholder="Length"
                                                aria-label="Length" aria-describedby="lenght"
                                                name="length"
                                                value="{{ old('length') }}"
                                            >
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input 
                                                ...
                                                aria-label="Video File" aria-describedby="video_file" name="video_url"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input 
                                                ...
                                                aria-label="Video Youtube URL" aria-describedby="video_youtube_url" name="video_youtube_url"
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select 
                                        class="select @error('product_subcategory_id') is-invalid @enderror"
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-btn">
                                    <a class="btn btn-added" onclick="duplicate()">
                                        <img src="{{ asset('admin/img/icons/plus.svg')}}" alt="img">Add New Variant
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <tr id="element-variant">
                                            <td>
                                                <input 
                                                    ...
                                                    value="{{ old('productDetails[0][name]') }}"
                                                    required
                                                >
                                            </td>
                                            <td>
                                                <input 
                                                    ...
                                                    value="{{ old('productDetails[0][price]') }}"
                                                    required
                                                >
                                            </td>
                                            <td>
                                                <input 
                                                    type="text" 
                                                    class="product-detail-discount-price" 
                                                    placeholder="Rp"
                                            ...
                                            <td>
                                                <input 
                                                    ...
                                                    value="{{ old('productDetails[0][stock]') }}"
                                                    required
                                                >
                                            </td>
                                            <td>
                                                <input 
                                                    ...
                                                    value="{{ old('productDetails[0][sku]') }}"
                                                    required
                                                >
                                            </td>
