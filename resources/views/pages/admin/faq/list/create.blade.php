...
@section('content')
    ...
    <form action="{{ route('admin.faq.list.store') }}" id="formSubmission" method="post" id=""
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select 
                                class="select @error('faq_categories') is-invalid @enderror"
                                id="faq_categories" 
                                name="faq_categories[]"
                                multiple 
                            >
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->name }}"
                                        @if ( is_array(old('faq_categories')) && in_array($category->name, old('faq_categories')) ) selected @endif>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('admin.faq.list.index') }}" class="btn btn-cancel">Cancel</a>
                </div>
            </div>
