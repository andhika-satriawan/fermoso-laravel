...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.faq.category.update', $item->id) }}" id="formSubmission" method="post" id="" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <a href="{{ route('admin.faq.category.index') }}" class="btn btn-cancel">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
