...
@section('content')
    ...
    <form action="{{ route('admin.article.blog.store') }}" id="formSubmission" method="post" id=""
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="summary" name="summary" class="form-control @error('summary') is-invalid @enderror">{{ old('summary') }}</textarea>
                            @error('summary')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            >
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->name }}"
                                        @if ( is_array(old('article_categories')) && in_array($category->name, old('article_categories')) ) selected @endif>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
