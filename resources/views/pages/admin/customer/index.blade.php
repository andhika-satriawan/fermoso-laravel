...
<div class="page-header">
    ...
    {{-- <div class="page-btn">
      <a href="{{ route('admin.customer.create') }}" class="btn btn-added">
        <img
                    ...
                    <tr>
                        ...
                        <td class="productimgname">
                            <a href="javascript:void(0);" class="product-img">
                                <img
                                    src="{{ !empty($customer->profile_photo) ? \Storage::disk('local')->url($customer->profile_photo) : asset('admin/img/product/noimage.png') }}"
                                    alt="product"
                                />
                            </a>
                        </td>
                        ...
                        <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $customer->created_at)->format('M d, Y, H:i:s') }}</td>
                        {{-- <td>
                            <a class="me-3" href="{{ route('admin.customer.edit', $customer->id)}}">
                                <img src="{{ asset('admin/img/icons/edit.svg')}}" alt="img" />
                            </a>
                            <a class="me-3 confirm-text" onclick="deleteConfirmation({{ $customer->id }})">
