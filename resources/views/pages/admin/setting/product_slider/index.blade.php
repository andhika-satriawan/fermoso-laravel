...
<div class="page-header">
    ...
    <div class="page-btn">
      <a href="{{ route('admin.setting.product-slider.create') }}" class="btn btn-added">
        <img
            ...
            <table class="table datanew">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $slider->title }}</td>
                        <td class="text-right">
                            <a class="me-3" href="{{ route('admin.setting.product-slider.edit', $slider->id)}}">
    ...
    const deleteConfirmation = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '{{ route("admin.setting.product-slider.index") }}/' + id,
                    data: {
